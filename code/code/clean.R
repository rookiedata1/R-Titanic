...
# Load the data sets
train <- read.csv("E:/Titanic/data/train.csv", stringsAsFactors = FALSE)  # 891 obs
test <- read.csv("E:/Titanic/data/test.csv", stringsAsFactors = FALSE)    # 418 obs
...
# Set "0" (did not survive) as the 默认值
test$survived <- 0
...
save("test", file = "E:/Titanic/data/test_clean.RData")
save("train", file = "E:/Titanic/data/train_clean.RData")

## Save the empty age data
save("test", file = "E:/Titanic/data/test_clean_age.RData")
save("train", file = "E:/Titanic/data/train_clean_age.RData")

# Save as ARFF for WEKA using foreign
write.arff(test, file = "E:/Titanic/data/test_clean.ARFF")
write.arff(train, file = "E:/Titanic/data/train_clean.ARFF")

# Also save .csv's just in case. These do not preserve data structures,
# so don't use them in the analysis! 
write.csv(test, "E:/Titanic/data/test_clean.csv", row.names = FALSE)
write.csv(train, "E:/Titanic/data/train_clean.csv", row.names = FALSE)
write.csv(full, "E:/Titanic/data/full.csv", row.names = FALSE)
